...
print.data.frame(RS_MFRM_Table1, row.names = FALSE)
```
...
# Print the table to the console
options(width = 50)
print.data.frame(RS_MFRM_Table2, row.names = FALSE)
```
...
print.data.frame(RS_MFRM_Table3[1:6,], row.names = FALSE)
```
...
# Print the table to the console
print.data.frame(RS_MFRM_Table4, row.names = FALSE)
```
...
# Print the table to the console
print.data.frame(PC_MFRM_Table1, row.names = FALSE)
```
...
# Print the first six rows of the table to the console
print.data.frame(PC_MFRM_Table2[1:6,], row.names = FALSE)
```
...
# Print the table to the console
print.data.frame(PC_MFRM_Table3, row.names = FALSE)
```
...
# Print the first six rows of the table to the console
print.data.frame(PC_MFRM_Table4[1:6,], row.names = FALSE)
```
