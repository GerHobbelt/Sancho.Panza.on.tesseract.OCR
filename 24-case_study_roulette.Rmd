...
To play roulette you place a bet and spin the wheel. If the wheel matches your bet you win; if not, you lose. Remember that a roulette wheel contains slots numbered 1 through 36, half of them red, half black and green 0 and 00 slots. 

```{r nice-fig-171, fig.cap='American Roulette Wheel', out.width='90%', fig.asp=.75, fig.align='center', echo=FALSE}
knitr::include_graphics("01-basics-figures/roulette_wheel.png")
```

The table layout allows a number of different bets

```{r nice-fig-172, fig.cap='American Roulette Layout', out.width='90%', fig.asp=.75, fig.align='center', echo=FALSE}
knitr::include_graphics("01-basics-figures/roulette_layout.png")
```

and payout schedule are below.
...
```{r nice-fig-173, fig.cap='Roulette Payoff Odds', out.width='90%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-174, fig.cap='Roulette Bet Positions', out.width='50%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-175, fig.cap='Roulette Even Money Disribution', out.width='90%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-176, fig.cap='Histogram for Tossing One Die', out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r nice-fig-177, fig.cap='Roulette Single Number Disribution', out.width='90%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-178, fig.cap='Histogram for Tossing One Die', out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r nice-fig-179, fig.cap='European Roulette Wheel and Layout', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
