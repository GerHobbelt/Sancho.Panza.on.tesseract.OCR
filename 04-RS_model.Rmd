...
RSM_person.summary.results_rounded <- round(RSM_person.summary.results[,1], digits = 2)
...
print.data.frame(RSM_Table1, row.names = FALSE)
```
...
# Print the table to the console:
options(wwidth = 50)
print.data.frame(RSM_Table2, row.names = FALSE)
```
...
options(width = 50)
print.data.frame(RSM_Table3[1:6,], row.names = FALSE)
```
