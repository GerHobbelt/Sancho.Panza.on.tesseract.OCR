...
tab1 <- read.csv("images/bookdownTable1.csv")
...
library(kableExtra)
tab2 <- read.csv("images/bookdownTable2.csv")
...
```{r AKmap, include=FALSE, eval=FALSE}
...
```{r mapOut, out.width = '100%', echo=FALSE, eval=FALSE}
AKmap
```
